...
| Refactoring | Decompose build, projection, binder, executor, evaluator, engine, persistence, SQL facade, sync, and test mega-modules without changing behavior during mechanical splits. |
