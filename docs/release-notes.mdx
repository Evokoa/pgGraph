...
- Graph generations publish through PostgreSQL transactions. Rollback,
  savepoints, reset, and drop preserve the generation visible to older
...
acceptance gate and refuses existing fixture databases and roles. It does not
replace the outstanding 1M/10M selective-RLS evidence. Candidate release gates
