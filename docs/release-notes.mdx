...
| Release history |
|---|
| [v1.2.1](#v1-2-1-pggraph-stability-release) |
...
<a id="v1-2-1-pggraph-stability-candidate" />

## v1.2.1: pgGraph Stability Release
...
- Topology reads in PostgreSQL read-only transactions defer retention
  housekeeping writes. Reader health diagnostics use authorized, graph-scoped
  catalog access while preserving source ACL and RLS checks.
