...
<Callout type="info">
No currently tracked P3 rows remain. The pgrx SQL test module layout is a
contributor-harness detail documented in the
[SQL Tests](./contributor_guide/sql-tests) guide, not a user-facing known issue.
</Callout>
