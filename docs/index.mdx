...
<ProjectBadges>
  ...
  <Badge label="version" value="0.1.1" color="green" href="https://github.com/Evokoa/pggraph/blob/main/graph/Cargo.toml" />
...
## How it Works
pgGraph builds a compact, derived graph index over selected relational tables to 
drastically accelerate query times. Because Postgres stays the system of record, 
all standard tables and constraints still apply to application writes.
