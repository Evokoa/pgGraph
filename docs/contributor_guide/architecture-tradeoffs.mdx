...
The published v0.1.8 line is alpha; the pgGraph 1.0.0 source tree is
release-ready but unpublished. Its architecture still reflects choices that are open to
critique. This page explains the main design choices, the tradeoffs behind
them, and the places where future work may prove a different direction is
better.
