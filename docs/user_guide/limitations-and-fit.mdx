...
| Query catch-up | Default query behavior does not apply pending sync rows; `graph.query_freshness = 'apply_pending_sync'` opts topology reads into bounded catch-up |
