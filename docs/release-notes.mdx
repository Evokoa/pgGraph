...
<Callout type="info">
  ...
  should use `v0.1.1`; this entry is retained so the release-notes page tracks
...
- `v0.1.1` supersedes this release and includes breaking SQL contract changes.
  Review the `v0.1.1` breaking changes before moving applications from
  `v0.1.0`.
