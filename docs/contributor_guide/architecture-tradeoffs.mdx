...
The published v0.1.8 line is alpha; this source tree contains the pgGraph 1.0.0
release candidate. Its architecture still reflects choices that are open to
