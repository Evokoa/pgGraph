...
The Homebrew formula is a convenience channel for PostgreSQL 17. The pgGraph
1.0 supported package matrix is the versioned PGXN/source archive and GHCR
images for PostgreSQL 14 through 18; use one of those channels when you require
the complete release-evidence contract.
