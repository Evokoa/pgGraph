...
| P1 | Query performance follow-ups | No active public rows after source-search rechecks, aggregation hydration ownership, and adaptive traversal metadata. |
| P2 | SQL ergonomics and documented semantics | No active public rows after structured filters and the edge-label cardinality limit were documented. |
| P3 | Internals and maintainability | No active public rows; the pgrx SQL test module layout is documented for contributors. |
