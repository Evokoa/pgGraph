...
The unreleased 1.1 direct traversal and path APIs build one statement-scoped
...
<Callout type="warning">
Caller-scoped topology RLS is not yet wired into every API on this development
branch. Components, aggregation, GQL/Cypher execution, and remaining derived
workflow/analytics paths stay builder-scoped until their ordered 1.1 phases
land. Do not treat those APIs as tenant-isolation boundaries yet.
</Callout>
