...
<ProjectBadges>
  ...
  <Badge label="version" value="1.0.0 release-ready" color="orange" href="https://github.com/Evokoa/pggraph/blob/main/graph/Cargo.toml" />
...
<Callout type="warning">
  The published line remains v0.1.8 alpha. This source contains pgGraph 1.0.0,
  which is release-ready but unpublished. Its SQL/GQL, resource, persistence,
  migration, and package contracts are frozen. Build the reviewed source commit
  until signed artifacts are announced.
</Callout>
