...
This section is a working release-note draft and is extended as the 1.1 phases
land.
...
The `1.0.0 -> 1.1.0` extension update changes the three query functions in
place, preserving their owners and explicit `EXECUTE` grants. The final 1.1
release notes will document the complete compatibility, artifact, rollback,
and RLS contract after the remaining phases finish.
